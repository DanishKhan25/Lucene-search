package com.tvelp.lucene.service.chat;

import com.tvelp.lucene.modal.domain.Address;
import com.tvelp.lucene.modal.domain.Chat;
import com.tvelp.lucene.modal.domain.ChatTypeEnum;
import com.tvelp.lucene.modal.domain.UserSummaryDto;
import com.tvelp.lucene.utils.JsonUtil;
...
public class ChatService {
    ...
    public List<Chat> search(String queryString) throws IOException, ParseException {
        ...
        try(IndexReader reader= DirectoryReader.open(directory)) {
            ...
            PrefixQuery prefixQuery = new PrefixQuery(new Term("content", queryString));
